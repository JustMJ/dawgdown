...
# This will automatically install the {remotes} package and {dawgdown}
# Change this to FALSE if you'd like to install them manually on your own.
params:
  'Install needed packages for {dawgdown}': True
  
# Remove the hashtag to specify which version of output you would like.
# Can only choose one at a time.
output:
  dawgdown::thesis_pdf: default 
#  dawgdown::thesis_gitbook: default         
#  dawgdown::thesis_word: default
#  dawgdown::thesis_epub: default
...
# This chunk ensures that the dawgdown package is
# installed and loaded. This dawgdown package includes
# the template files for the thesis.
if (!require(remotes)) {
  if (params$`Install needed packages for {dawgdown}`) {
